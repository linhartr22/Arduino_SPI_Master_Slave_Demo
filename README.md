This project implements SPI Master Slave communication with two Arduinos. These examples can be used to implement an Arduino SPI Master or Slave device.
